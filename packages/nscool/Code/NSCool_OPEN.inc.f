...
c       Print out inner crust:
     ...
     6      a5,0p3f7.1)')                           !JK
     1       i,rad(i)/100.,emas(i),rrho(i),pres(i),bar(i),
     2       kfe(i),0.,0.,kfn(i),0.,0.,0.,0.,
     3       tcn(i),0.,0.,
     4       0,0,0,0,0,
     5       mstn(i),mstp(i),
     6       what,a_cell(i),a_ion(i),z_ion(i)       !JK
        end do
...
c ***********************************************************************
      if (ptemp.eq.1) then
       ...
       write(10,'(a)')'#   Time in years,  Te_inf includes ephi'
       write(10,'(a)')'#   Temp and Lum are local values, i.e. no ephi'
       write(10,'(a)')'#'
       write(10,'(a)')'#'
      end if
c ***********************************************************************
...
!      if (pstar.eq.1.) then
!      open(unit=19,file=Lnu_results,status='new')
!      endif
c ***********************************************************************
c ***********************************************************************
c ***********************************************************************
